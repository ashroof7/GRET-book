...
\centering
  \mbox{
      \subfigure[]{
            \label{fig:binary_op}
            \includegraphics[width=.6\textwidth]{./Pictures/vfc.png}
        }
...
\centering
  \mbox{
      \subfigure[]{
            ...
            \includegraphics[width=.9\textwidth]{./Pictures/dynamic15.png}
        }
...
\centering
  \mbox{
      \subfigure[]{
            ...
            \includegraphics[width=.8\textwidth]{./Pictures/dynamic16.png}
        }
...
\centering
  \mbox{
      \subfigure[]{
            \label{fig:r_knn_b}
            \includegraphics[width=.9\textwidth]{./Pictures/R_K-NN_B.jpg}
        }
   }
...
\centering
  \mbox{
      \subfigure[]{
            \label{fig:r_knn_f}
            \includegraphics[width=.9\textwidth]{./Pictures/R_K-NN_F.jpg}
        }
   }
